...
public class ParcelasDAO {
    ...
    // Adicionar métodos para parcelas por financiamento
    public List<Parcelas> buscarPorFinanciamento(int financiamentoId) {
        List<Parcelas> parcelas = new ArrayList<>();
        String sql = "SELECT * FROM parcelas WHERE financiamento_id = ? ORDER BY numero_parcela";
        ...
        try (PreparedStatement stmt = conexao.prepareStatement(sql)) {
            ...
            throw new RuntimeException("Erro ao buscar parcelas por financiamento: " + e.getMessage(), e);
        }
        return parcelas;
    }

    public void deletarParcelasDoFinanciamento(int financiamentoId) {
        ...
        try (PreparedStatement stmt = conexao.prepareStatement(sql)) {
            ...
            throw new RuntimeException("Erro ao deletar parcelas do financiamento: " + e.getMessage(), e);
        }
    }
